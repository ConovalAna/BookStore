    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BookID = table.Column<int>(type: "int", nullable: false),
                    SBN = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "UserWaitingBooks",
                columns: table => new
                {
                    UserWaitingBookID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    BookID = table.Column<int>(type: "int", nullable: false),
                    UserProfileID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWaitingBooks", x => x.UserWaitingBookID);
                    table.ForeignKey(
                        name: "FK_UserWaitingBooks_Books_BookID",
                        column: x => x.BookID,
                        principalTable: "Books",
                        principalColumn: "BookID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWaitingBooks_UserProfiles_UserProfileID",
                        column: x => x.UserProfileID,
                        principalTable: "UserProfiles",
                        principalColumn: "UserProfileID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWaitingBooks_BookID",
                table: "UserWaitingBooks",
                column: "BookID");

            migrationBuilder.CreateIndex(
                name: "IX_UserWaitingBooks_UserProfileID",
                table: "UserWaitingBooks",
                column: "UserProfileID");
        }
